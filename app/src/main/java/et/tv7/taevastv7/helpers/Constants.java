...
abstract public class Constants {
    ...
    public static final String STREAM_URL = "https://vod.tv7.fi:443/tv7-ee/_definst_/smil:tv7-ee.smil/playlist.m3u8";
    public static final String ARCHIVE_BASE_URL = "https://www.tv7.ee/wp-json/tv7-api/v1/";
    public static final String ARCHIVE_VIDEO_URL = "https://vod.tv7.fi:443/vod/_definst_/mp4:_LINK_PATH_/playlist.m3u8";

    public static final String ARCHIVE_LANGUAGE = "ET1";
    public static final String TRANSLATION_LANG_ID = "et";
    public static final String EPG_CHANNEL = "ET1";
    public static final String EPG_LANG = "et";
    ...
    public static final List<et.tv7.taevastv7.helpers.MenuItem> MENU_ITEM_IDS = new ArrayList<>(Arrays.asList(
        new et.tv7.taevastv7.helpers.MenuItem(R.id.tvMenuContainer, R.id.tvMenuText),
        new et.tv7.taevastv7.helpers.MenuItem(R.id.archiveMenuContainer, R.id.archiveMenuText),
        new et.tv7.taevastv7.helpers.MenuItem(R.id.guideMenuContainer, R.id.guideMenuText),
        new et.tv7.taevastv7.helpers.MenuItem(R.id.searchMenuContainer, R.id.searchMenuText)
    ));
